...
(() => {
    ...
    if (validPages.some(page => window.location.pathname.endsWith(page))) {
        ...
        const sonidoCorrecta = new Audio('https://eml.com.co/elearning_nutri_baby/correcta.mp3');
        const sonidoIncorrecta = new Audio('https://eml.com.co/elearning_nutri_baby/incorrecta.mp3');
